...
public:
	...
	void SetContainerPadding(const char *containerPadding) {
	...
	void SetKeyPaddingLeft(const char *keyPaddingLeft) {
		this->keyPaddingLeft = keyPaddingLeft;
	}

	const char *GetKeyPaddingRight() {
		return keyPaddingRight;
	}
	void SetKeyPaddingRight(const char *keyPaddingRight) {
		this->keyPaddingRight = keyPaddingRight;
	}
	...
	void SetDefaultContainerLayout(ContainerLayout layout) {
		this->defaultContainerLayout = layout;
	}
	...
	void SetForceDefaultContainerLayout(bool force) {
		this->forceDefaultContainerLayout = force;
	}
